...
4.3 Создаём роль. Роль - это логическое имя, присвоенное совокупности параметров сертификатов, выпускаемых этим центром сертификации.
...
Попробуем открыть сервер в браузере:
![img_1.png](img_1.png)
